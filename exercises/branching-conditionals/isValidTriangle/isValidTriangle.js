...
if (require.main === module) {
  ...
  console.log(isValidTriangle(2, 2, 5) === false);
  console.log(isValidTriangle(3, 1, 5) === false);
  console.log(isValidTriangle(2, 3, 6) === false);
  console.log(isValidTriangle(3, 2, 5) === false);
